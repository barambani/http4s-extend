...
private[syntax] class IoResponseResultOps(val response: IO[Response[IO]]) extends AnyVal {
...
private[syntax] class VerifiedOps[A](val a: A) extends AnyVal {
...
private[syntax] class VerifiedOptionOps[A](val a: Option[A]) extends AnyVal {
