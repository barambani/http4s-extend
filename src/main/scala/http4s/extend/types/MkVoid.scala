...
private[types] sealed trait VoidScalazTypeclassInstances {

  implicit def scalazMonadError[F[_], E](implicit M: scalaz.MonadError[F, E], I: Iso[E, Void]): cats.MonadError[F, Void] =
    new cats.MonadError[F, Void] {
