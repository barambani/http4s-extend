...
[![scaladex](https://img.shields.io/badge/scaladex-http4s--extend-orange.svg)](https://index.scala-lang.org/barambani/http4s-extend/http4s-extend)
...
```scala
libraryDependencies += "com.github.barambani" %% "http4s-extend" % "0.0.43"
```
...
| ------ |:---------:|:---------:|:-----------------:|
| 0.0.43 | 0.18.19   | 3.0.0-RC1 | 7.3.0-M25         |
